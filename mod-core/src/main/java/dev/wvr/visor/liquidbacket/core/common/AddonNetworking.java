...
public class AddonNetworking {
    ...
    public static final ResourceLocation FLUID_BUCKET_C2S = new ResourceLocation(VRLiquidBucket.MOD_ID, "fluid_bucket_c2s");
    ...
    public static void initCommon() {
        ...
        NetworkHelper.registerServerReceiver(FLUID_BUCKET_C2S, (buf, player) -> {
            BucketInteractionHandler.fluidBucket(
                    player,
                    buf.readInt(),
                    readVec3(buf)
            );
